            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12 col-sm-4">
                    ...
                    <ul class="top-menu text-right list-inline">
                        ...
                        @auth
                            <li><button type="button" onclick="document.getElementById('logout-form').submit()">Logout</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-sm-3">
                                        <ul>
                                            ...
                                            <li role="separator" class="divider"></li>
                                            <li><a href="{{route('sidebar')}}">Shop With Sidebar</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <ul>
                                            ...
                                            <li><a href="{{ route('regiter')}}">Signin Page</a></li>
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <a href="shop.html">
                                            <img class="img-responsive"
                                                src="{{ asset('assets/images/shop/header-img.jpg') }}"
                                                alt="menu image" />
                                        </a>
                                    </div>
                                </div><!-- / .row -->
