...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        {{-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('assets/admin/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60"
                width="60">
        </div> --}}
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('admin.products.management')}}" class="nav-link active">
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('admin.products.variants.create')}}" class="nav-link active">
