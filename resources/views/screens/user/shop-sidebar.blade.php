            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        ...
                        <x-product-card name="{{ $product->name}}" img="assets/images/shop/products/product-1.jpg" price="{{ $product->price}}" sale="Sale 20% off " link="{{ route('product.details',$product->slug )}}"/>
                        ...
                        <div class="col-md-4">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="{{asset('assets/images/shop/products/product-4.jpg')}}"
                                        alt="product-img" />
                                    <div class="preview-meta">
                                        <ul>
                                            <li>
                        ...
                        <div class="col-md-4">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="{{asset('assets/images/shop/products/product-6.jpg')}}"
                                        alt="product-img" />
                                    <div class="preview-meta">
                                        <ul>
                                            <li>
                        ...
                        <div class="col-md-4">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <span class="bage">Sale</span>
                                    <img class="img-responsive" src="{{asset('assets/images/shop/products/product-7.jpg')}}"
                                        alt="product-img" />
                                    <div class="preview-meta">
                                        <ul>
                                            <li>
                        ...
                        <div class="col-md-4">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="{{asset('assets/images/shop/products/product-8.jpg')}}"
                                        alt="product-img" />
                                    <div class="preview-meta">
                                        <ul>
                                            <li>
                        ...
                        <div class="col-md-4">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="{{asset('assets/images/shop/products/product-9.jpg')}}"
                                        alt="product-img" />
                                    <div class="preview-meta">
                                        <ul>
                                            <li>
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-12">
                                                <div class="modal-image">
                                                    <img class="img-responsive"
                                                        src="{{asset('assets/images/shop/products/modal-product.jpg')}}" alt="product-img" />
                                                </div>
                                            </div>
