                ...
                <div class="row">
                    ...
                    <div class="contact-form col-md-6 ">
                        <form id="contact-form" method="post" action="" role="form">
                            <x-test type="text" placeholder="Your Name" />
                            <x-test type="email" placeholder="Your eamil" />
                            <x-test type="text" placeholder="Subject" />
                            <x-test type="msg" placeholder="Messege" rows="6"  />
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/plugins/google-map/images/marker.png')}}"></script>
@endsection
