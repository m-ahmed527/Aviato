                            ...
                            <div class='carousel-outer'>
                                ...
                                <div class='carousel-inner '>
                                    <div class='item active'>
                                        <img src='{{ asset('assets/images/shop/single-products/product-1.jpg') }}'
                                            alt=''
                                            data-zoom-image="{{ asset('assets/images/shop/single-products/product-1.jpg') }}" />
                                    </div>
                                    <div class='item'>
                                        <img src='{{ asset('assets/images/shop/single-products/product-2.jpg') }}'
                                            alt=''
                                            data-zoom-image="{{ asset('assets/images/shop/single-products/product-2.jpg') }}" />
                                    </div>

                                    <div class='item'>
                                        <img src='{{ asset('assets/images/shop/single-products/product-3.jpg') }}'
                                            alt=''
                                            data-zoom-image="{{ asset('assets/images/shop/single-products/product-3.jpg') }}" />
                                    </div>
                                    <div class='item'>
                                        <img src='{{ asset('assets/images/shop/single-products/product-4.jpg') }}'
                                            alt=''
                                            data-zoom-image="{{ asset('assets/images/shop/single-products/product-4.jpg') }}" />
                                    </div>
                                    <div class='item'>
                                        <img src='{{ asset('assets/images/shop/single-products/product-5.jpg') }}'
                                            alt=''
                                            data-zoom-image="{{ asset('assets/images/shop/single-products/product-5.jpg') }}" />
                                    </div>
                                    <div class='item'>
                                        <img src='{{ asset('assets/images/shop/single-products/product-6.jpg') }}'
                                            alt=''
                                            data-zoom-image="{{ asset('assets/images/shop/single-products/product-6.jpg') }}" />
                                    </div>
                    ...
                    <form action="{{ route('cart.add',$product->slug)}}" method="POST">
                        ...
                        @endforeach --}}
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt, velit, sunt temporibus,
                                nulla
                                accusamus similique sapiente tempora, at atque cumque assumenda minus asperiores est esse
                                sequi
                            ...
                            @foreach ($product->attributes as $key => $attr)
                                <div class="product-size">
                                    ...
                                    <select class="form-control">
                                        @foreach ($product->variants as $variant)
                                            @if ($variant->attribute_id == $attr->variants[$key]->attribute_id)
                                ...
                                <div class="post-comments">
                                    <ul class="media-list comments-list m-bot-50 clearlist">
                                        ...
                                        <li class="media">
                                            ...
                                            <a class="pull-left" href="#!">
                                                <img class="media-object comment-avatar"
                                                    src="{{ asset('assets/images/blog/avater-1.jpg') }}" alt=""
                                                    width="50" height="50" />
                                            </a>
                                        ...
                                        <li class="media">
                                            ...
                                            <a class="pull-left" href="#!">
                                                <img class="media-object comment-avatar"
                                                    src="{{ asset('assets/images/blog/avater-4.jpg') }}" alt=""
                                                    width="50" height="50" />
                                            </a>
